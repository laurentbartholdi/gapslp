...
gap> textSLP := AssocWordBySLP(FamilyObj(f.1), [[1,1,2,1],[4,1,3,1],[5,2],[6,2],[7,2],[8,2],[9,2]]);;
gap> patternSLP := AssocWordBySLP(FamilyObj(f.1), [[1,1,2,1],[4,1,3,1],[5,1,5,1],[6,2],[3,1,7,1],[7,1,1,1],[8,1,9,1]]);;
gap> Occurrences(textSLP, patternSLP)[Length(Occurrences(textSLP, patternSLP))] = [24,3,8];
true
...
gap> Occurrences(textSLP, patternSLP)[Length(Occurrences(textSLP, patternSLP))] = [30,3,6];
true
gap> #LC1-2
gap> #RC1-2
gap> f := FreeGroup(IsSLPWordsFamily,3);;
...
gap> patternSLP := AssocWordBySLP(FamilyObj(f.1), [[1,1,2,1], [4,1,3,1], [5,1,5,1], [6,1,6,1], [3,1,7,1], [7,1,1,1], [8,1,9,1]]);;
gap> Occurrences(textSLP, patternSLP)[Length(Occurrences(textSLP, patternSLP))] = [3,3,6];
true
gap> #LC2
gap> f := FreeGroup(IsSLPWordsFamily,3);;
...
gap> Occurrences(textSLP, patternSLP)[Length(Occurrences(textSLP, patternSLP))] = [4,0,0];
true
gap> #RC2
gap> f := FreeGroup(IsSLPWordsFamily,3);;
...
gap> Occurrences(textSLP, patternSLP)[Length(Occurrences(textSLP, patternSLP))] = [10,0,0];
true
gap> #RC3
gap> f := FreeGroup(IsSLPWordsFamily,3);;
...
gap> Occurrences(textSLP, patternSLP)[Length(Occurrences(textSLP, patternSLP))] = [16,0,0];
true
gap> #RC4-1
gap> f := FreeGroup(IsSLPWordsFamily,5);;
...
gap> Occurrences(textSLP, patternSLP)[Length(Occurrences(textSLP, patternSLP))] = [11,0,0];
true
gap> #LC4-2
gap> f := FreeGroup(IsSLPWordsFamily,5);;
...
gap> patternSLP := AssocWordBySLP(FamilyObj(f.1), [[1,1,2,1], [6,1,3,1], [7,1,4,1], [8,1,5,1], [9,1,9,1], [10,1,10,1], [1,1,5,1], [10,1,12,1], [11,1,13,1]]);;
gap> Occurrences(textSLP, patternSLP)[Length(Occurrences(textSLP, patternSLP))] = [];
true
gap> #RC4-2
gap> f := FreeGroup(IsSLPWordsFamily,5);;
